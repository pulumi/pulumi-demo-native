...
namespace Pulumi.DemoNative
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.DemoNative.version.txt");
    ...
    internal sealed class DemoNativeResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public DemoNativeResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
